...
export const colors = defineSemanticTokens.colors({
  bg: {
    DEFAULT: {
      value: {
        _light: "{colors.white}",
        _dark: "{colors.leaf.700}",
      },
    },
    subtle: {
      value: {
        _light: "{colors.leaf.50}",
  ...
  leaf: {
    subtle: {
      value: {
        _light: "{colors.leaf.100}",
        _dark: "{colors.leaf.700}",
      },
    },
    solid: {
      value: {
        _light: "{colors.leaf.600}",
        _dark: "{colors.leaf.200}",
      },
    },
    contrast: {
      value: {
  ...
  sea: {
    subtle: {
      value: {
        _light: "{colors.sea.100}",
        _dark: "{colors.sea.700}",
      },
    },
    solid: {
      value: {
        _light: "{colors.sea.500}",
        _dark: "{colors.sea.200}",
      },
    },
    contrast: {
      value: {
